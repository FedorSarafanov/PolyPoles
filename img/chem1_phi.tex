	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		[
		    ...
		    create on use/tg/.style={
		        create col/expr={
		        tan(asin(\thisrow{a}/\thisrow{b}))
		        }
		    },			    
		    ...
		    create on use/DP/.style={
		        create col/expr={
		        ((0.1/\thisrow{a}+0.1/\thisrow{b})*\thisrow{a}/\thisrow{b})/
		        	(1-(\thisrow{a}/\thisrow{b})^2)^(3/2)
		        }
		    },			    	    	    	
			x=omega, 
			y=tg, 
		...
		{../data/chem1.tsv};
	     ...
	     \addplot [samples=100, domain=70:3000*6.28, blue] {1/(x*\R*\C)};
