...
\subsubsection{Эквивалентная схема}
...
\begin{figure}[H]
	\begin{minipage}[h]{0.49\linewidth}
		\center{\includegraphics[width=1.1\linewidth]{img/ris6.pdf} \\ а)}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.49\linewidth}
		\center{\includegraphics[width=1.1\linewidth]{img/ris6_phi.pdf} \\ б)}
	\end{minipage}
